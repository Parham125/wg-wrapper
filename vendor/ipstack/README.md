> Vendored copy of [ipstack](https://github.com/tun2proxy/ipstack) 1.0.1 with a configurable TCP idle
> timeout: `IpStackConfig::tcp_timeout` replaces the hardcoded 60 second `TIMEOUT` in `src/stream/tcp.rs`.
